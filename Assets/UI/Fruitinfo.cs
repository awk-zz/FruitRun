...
public class FruitInfoPanel : MonoBehaviour
{
    ...
    private string[] fruitDescriptions = new string[3]  // 水果的描述数组
    {
        ...
        "Mad Berry is a hot-tempered and fragile blueberry. The slightest bump can make him explode in anger. During his long journey in transportation, Mad Berry was constantly jostled around, which only fueled his rage. Though small in size, his fury is enough to destroy anything in his way. Being trapped in the fridge only made him angrier, and now he’s determined to break free and find new freedom.",

        "Crush Apple is a dreamy apple, filled with romantic fantasies. She grew up under the fear of 'an apple a day keeps the doctor away,' but instead of feeling anxious, she longs for the beauty of life. Whether it’s handsome men or beautiful women, Crush Apple is always eager to witness the wonders of the world. Confined in the fridge, she feels lost and helpless, unable to find anything beautiful. Now, Crush Apple has made up her mind to escape and explore the outside world, seeking the beauty and romance she dreams of."
    };
